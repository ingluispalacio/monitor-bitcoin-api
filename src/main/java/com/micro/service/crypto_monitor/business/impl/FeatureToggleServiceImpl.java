...
import com.micro.service.crypto_monitor.mapper.FeatureToggleMapper;
...
public class FeatureToggleServiceImpl implements FeatureToggleService {
        ...
        public Mono<ApiResponseDTO<List<FeatureToggleDTO>>> getAll() {
                ...
                return featureToggleRepository.findAll()
                                .map(featureToggleMapper::toDTO)
                                .collectList()
                                .map(list -> ApiResponseDTO.<List<FeatureToggleDTO>>builder()
                                                .success(true)
                                                .message("Lista de toggles obtenida correctamente")
                                                .data(list)
                                                .timestamp(LocalDateTime.now())
                                                .build())
                                .doOnNext(resp -> log.info("FeatureToggleService getAll success, count={}",
                                                resp.getData().size()))
                                .doOnError(err -> log.error("FeatureToggleService getAll error", err));
        }

        @Override
        public Mono<ApiResponseDTO<FeatureToggleDTO>> getById(UUID id) {
                ...
                return featureToggleRepository.findById(id)
                                ...
                                .map(toggle -> ApiResponseDTO.<FeatureToggleDTO>builder()
                                                .success(true)
                                                .message("Toggle encontrado")
                                                .data(toggle)
                                                .timestamp(LocalDateTime.now())
                                                .build())
                                .doOnNext(resp -> log.info("getById éxito, id={}, active={}", id,
                                                resp.getData().getActive()))
                                .onErrorResume(ex -> {
                                        log.error("getById error id={}: {}", id, ex.getMessage());
                                        return Mono.just(ApiResponseDTO.<FeatureToggleDTO>builder()
                                                        .success(false)
        ...
        @Override
        public Mono<ApiResponseDTO<FeatureToggleDTO>> getByModuleName(String moduleName) {
                ...
                return featureToggleRepository.findByModuleName(moduleName)
                                ...
                                .map(toggle -> ApiResponseDTO.<FeatureToggleDTO>builder()
                                                ...
                                                .timestamp(LocalDateTime.now())
                                                .build())
                                .doOnNext(resp -> log.info("getByModuleName éxito: moduleName={}, active={}",
                                                moduleName, resp.getData().getActive()))
                                .onErrorResume(ex -> {
                                        log.error("getByModuleName error moduleName={}: {}", moduleName,
                                                        ex.getMessage());
                                        return Mono.just(ApiResponseDTO.<FeatureToggleDTO>builder()
                                                        .success(false)
                                                        .message(ex.getMessage())
        ...
        public Mono<ApiResponseDTO<Boolean>> isActive(String module) {
                ...
                return featureToggleRepository
                                ...
                                .map(active -> ApiResponseDTO.<Boolean>builder()
                                                ...
                                                .timestamp(LocalDateTime.now())
                                                .build())
                                .doOnNext(resp -> log.info("isActive result module={}, active={}", module,
                                                resp.getData()));
        }

        @Override
        public Mono<ApiResponseDTO<FeatureToggleDTO>> create(FeatureToggleDTO dto) {

                FeatureToggle toggle = featureToggleMapper.toEntity(dto);
                toggle.setId(UUID.randomUUID());

                return featureToggleRepository.existsByModuleName(dto.getModuleName())
                                .flatMap(exists -> {
                                        if (exists) {
                                ...
                                .map(featureToggleMapper::toDTO)
                                .map(response -> ApiResponseDTO.<FeatureToggleDTO>builder()
                                                .success(true)
                                                .message("Toggle creado correctamente")
                                                .data(response)
                                                .timestamp(LocalDateTime.now())
                                                .build())
                                .onErrorResume(ex -> Mono.just(ApiResponseDTO.<FeatureToggleDTO>builder()
                                                .success(false)
                                                .message(ex.getMessage())
                                                .data(null)
                                                .timestamp(LocalDateTime.now())
        ...
        @Override
        public Mono<ApiResponseDTO<FeatureToggleDTO>> activate(String moduleName) {
                return featureToggleRepository.findByModuleName(moduleName)
                                .switchIfEmpty(Mono.error(new RuntimeException("Módulo no encontrado")))
                                .flatMap(toggle -> {
                                ...
                                .map(featureToggleMapper::toDTO)
                                .map(updated -> ApiResponseDTO.<FeatureToggleDTO>builder()
                                                .success(true)
        ...
        @Override
        public Mono<ApiResponseDTO<FeatureToggleDTO>> deactivate(String moduleName) {
                return featureToggleRepository.findByModuleName(moduleName)
                                .switchIfEmpty(Mono.error(new RuntimeException("Módulo no encontrado")))
                                .flatMap(toggle -> {
        ...
        @Override
        public Mono<ApiResponseDTO<FeatureToggleDTO>> update(UUID id, FeatureToggleDTO dto) {
                return featureToggleRepository.findById(id)
                                .switchIfEmpty(Mono.error(new RuntimeException("Toggle no encontrado")))
                                .flatMap(existing -> {
